...
namespace AnimalAPI.Services.CharacterService
{
    public class CharacterService : ICharacterService
    {
        ...
        public async Task<ServiceResponse<GetCharacterDto>> GetCharacterById(int id)
        {
            ...
            Character dbCharacter = await _context.Characters.FirstOrDefaultAsync(cancellationToken => cancellationToken.Id == id);
